...
module.exports = function() {
  return function seajs(type, options, next) {
    var model = {
    ...
    if (options.i18n) {
      model.i18n = JSON.stringify(options.i18n)
      model.lang = 'navigator.language || navigator.browserLanguage || \'' + options.i18n[0] + '\''
    }
    ...
    vfs.src(path.join(__dirname, options.i18n ? '../../tpl/sea-i18n/**' :  '../../tpl/sea/**'), {
        dot: true
      })
      .pipe(template(model))
      .pipe(vfs.dest('.'))
