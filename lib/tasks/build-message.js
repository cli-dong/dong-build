...
module.exports = function() {
  return function message(type, options, next) {
    ...
    function merge(lang, index, done, display) {
    ...
    ;(options.i18n || ['zh-CN']).forEach(function(lang, index) {
      // error file
      queue.use(function(done) {
        merge(lang, index, done, ' 错误信息文件')
      })
    })
